                    ...
                    {engagementLogs.map((sub: Submission) => (
                      <div key={sub.id} className="bg-[var(--panel-bg)] border border-[var(--border)] p-4 rounded-2xl hover:border-purple-500/20 transition group">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <span className="text-[11.5px] font-bold text-purple-600 dark:text-purple-400 bg-purple-500/15 px-2.5 py-1 rounded-full shrink-0 ml-2">{Math.round(sub.score)} XP</span>
                        </div>
                      ...
                      <tbody>
                        {engagementLogs.map((sub: Submission) => (
                          <tr key={sub.id} className="border-b border-[var(--border)] hover:bg-purple-500/5 transition text-xs">
                            ...
                            <td className="py-2 px-3 text-right font-bold text-purple-600 dark:text-purple-400">{Math.round(sub.score)}</td>
