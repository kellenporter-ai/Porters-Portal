  ...
  const handleSaveResourceOrder = useCallback(async (unit: string) => {
    ...
    try {
      ...
      if (existing) {
        ...
        await dataService.saveClassConfig({ id: filterClass, className: filterClass, unitOrder: undefined, resourceOrder: newResourceOrder, features: { evidenceLocker: false, leaderboard: false, communications: false, dungeons: true, pvpArena: true, bossFights: true } } as ClassConfig);
      }
  ...
  const handleSaveUnitOrder = useCallback(async () => {
    ...
    try {
      ...
      if (existing) {
        ...
        await dataService.saveClassConfig({ id: filterClass, className: filterClass, unitOrder: pendingOrder, features: { evidenceLocker: false, leaderboard: false, communications: false, dungeons: true, pvpArena: true, bossFights: true } } as ClassConfig);
      }
