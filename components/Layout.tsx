...
const Layout: React.FC<LayoutProps> = ({ user, onLogout }) => {
  ...
  return (
    <div className={`flex flex-col lg:flex-row h-screen overflow-hidden text-[var(--text-primary)] relative ${settings.performanceMode ? 'perf-mode' : ''}`}>
      ...
      {/* Main Content */}
      <main id="main-content" className={`flex-1 overflow-y-auto p-2 pb-20 md:p-4 md:pb-20 lg:p-4 lg:pb-4 animate-fade-in ${settings.performanceMode ? 'no-anim' : 'animate-slide-up'}`}>
